      ...
      <section className="ref-home-shell">
        ...
        <main className="ref-hero">
          <div className="ref-copy">
            ...
            <Reveal delayMs={220}><p className="ref-trust">Every read shows what&apos;s verified, what&apos;s estimated, and what&apos;s still missing.</p></Reveal>
          </div>
