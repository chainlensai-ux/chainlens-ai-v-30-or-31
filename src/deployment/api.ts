...
export type SanitizedReportV2 = SanitizedReport & Pick<RunWalletScanV2Result, 'holdings' | 'portfolio' | 'pricingAudit' | 'walletScanPerformanceAudit' | 'unrealizedPriceUsageAudit'>
...
export type ScanModules = {
  ...
  pricingProvidersStatus: SanitizedReportV2['pricingProvidersStatus']
}
...
export function buildModules(sanitized: SanitizedReportV2): ScanModules {
  return {
    ...
    pricingProvidersStatus: sanitized.pricingProvidersStatus,
  }
}
