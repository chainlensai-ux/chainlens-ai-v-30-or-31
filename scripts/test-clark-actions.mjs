...
// 4. Market context: top mover Token Scanner CTA only appears when a real scanTarget exists.
{
  ...
  assert.ok(!withTarget.actions.some((a) => a.label === 'Open Base Radar'), 'market actions never include Open Base Radar')
  assert.ok(withTarget.actions.some((a) => a.label === 'Open Token Scanner' && a.href === '/terminal/token-scanner'))
