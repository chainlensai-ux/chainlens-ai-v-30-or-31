...
async function main() {
  ...
  assert.ok(ui.includes("result.concentratedLpPositionAudit ?? result.concentratedLpPositionOwnershipAudit"))
  assert.ok(ui.includes('Unavailable — owner evidence missing'))
