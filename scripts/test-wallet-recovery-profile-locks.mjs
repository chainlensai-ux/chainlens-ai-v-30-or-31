...
assert.match(snap, /eligible: _historicalEligible \|\| _historicalNotRunDueToCostGuard \|\| _acquisitionRecoveryEligible,/, 'targeted acquisition recovery eligibility is reflected in eligible diagnostics')
