...
assert.match(routeCode, /renderQuickTokenScan\(fullEvidence, chainDisplayLabel\(followupChain\)\)/, 'the momentum-rank follow-up uses the ranked item chain, never a hardcoded Base fallback')
