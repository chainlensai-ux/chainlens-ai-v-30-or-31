...
assert.ok(route.includes('promptAsSupported') && route.includes('extractRequestedChainFromPrompt(prompt)'), 'explicit ETH prompt chain must override UI/default chain')
