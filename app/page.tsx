...
function AvatarOrInitials({ src, initials, grad, name, imgPos, imgFilter, imgZoom, imgFit }: { src: string; initials: string; grad: string; name: string; imgPos?: string; imgFilter?: string; imgZoom?: number; imgFit?: 'cover' | 'contain' }) {
        ...
        <section style={{
          ...
          <div className="mob-grid-1" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
            {[
              ...
              { handle: '@StardomJnr', name: 'Stardom',            initials: 'S', grad: 'linear-gradient(135deg,#7f1d1d,#991b1b)', avatar: '/testimonials/stardom.png',    date: 'Apr 29, 2026', verified: true,  imgPos: 'center center', imgZoom: 1.2, imgFit: 'contain', quote: 'Chainlens AI is basically an onchain analytics copilot that turns wallet and token data into quick, readable insights for faster trading decisions.' },
            ].map((t, i) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <AvatarOrInitials src={t.avatar} initials={t.initials} grad={t.grad} name={t.name} imgPos={(t as any).imgPos} imgFilter={(t as any).imgFilter} imgZoom={(t as any).imgZoom} imgFit={(t as any).imgFit} />
                  {/* Name + handle */}
