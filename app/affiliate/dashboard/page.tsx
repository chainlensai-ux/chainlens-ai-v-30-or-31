...
// v38 latin-subset weight 500/600 normal/italic woff2 files (via next/font/local) removes that
// network dependency entirely, so the build no longer depends on Google Fonts being reachable.
// Same font, same 4 weight/style variants, same --font-fraunces CSS variable, same display: 'swap'
// — no visual change.
const fraunces = localFont({
  src: [
    { path: '../../../public/fonts/fraunces/fraunces-500-normal.woff2', weight: '500', style: 'normal' },
    { path: '../../../public/fonts/fraunces/fraunces-600-normal.woff2', weight: '600', style: 'normal' },
    { path: '../../../public/fonts/fraunces/fraunces-500-italic.woff2', weight: '500', style: 'italic' },
    { path: '../../../public/fonts/fraunces/fraunces-600-italic.woff2', weight: '600', style: 'italic' },
  ],
