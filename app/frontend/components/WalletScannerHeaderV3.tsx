...
export function WalletScannerHeaderV3({ report, loading, isFullRecoveryAdmin, onDeepScan, onAdminAction, deepScanDisabled, robinhoodResult }: WalletScannerHeaderV3Props) {
  return (
    <div
