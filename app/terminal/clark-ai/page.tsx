  ...
  return (
    <div className='clk-page'>
      <style>{`
        ...
        .clk-quick-title { display:block; margin:0; font-weight:750; font-size:14.5px; line-height:1.3; letter-spacing:-.005em; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        .clk-quick-sub { display:block; margin:0; color:#7c8aa1; font-size:12px; font-weight:600; line-height:1.35; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        .clk-tab { min-height:0; border:1px solid transparent; border-radius:9px; background:transparent; color:#7f8ea3; font-weight:700; font-size:13px; letter-spacing:.01em; cursor:pointer; padding:9px 18px; display:flex; gap:7px; align-items:center; justify-content:center; transition:background .15s, color .15s, border-color .15s; }
        ...
        .clk-intro--empty { display:flex; flex-direction:column; align-items:flex-start; width:100%; padding:26px 26px 8px; gap:18px; }
        .clk-intro-title { color:#d3dae6; font-weight:750; font-size:16px; margin:0; }
        .clk-intro-text { margin:0; color:#8391a7; line-height:1.55; font-size:13.5px; max-width:560px; }
        .clk-start-with { width:100%; }
        .clk-start-with-label { display:block; margin-bottom:10px; color:#5b6b84; font:750 10.5px var(--font-plex-mono, monospace); letter-spacing:.10em; text-transform:uppercase; }
        .clk-start-with-row { display:flex; flex-wrap:wrap; gap:10px; }
        .clk-start-chip { border:1px solid rgba(34,211,238,.2); border-radius:10px; background:rgba(34,211,238,.04); color:#a7e8f5; font-weight:700; font-size:13.5px; padding:10px 16px; cursor:pointer; transition:border-color .15s, background .15s, color .15s; }
        .clk-start-chip:hover { border-color:rgba(45,212,191,.45); background:rgba(45,212,191,.09); color:#ccfbf1; }
        .clk-msg { max-width:min(90%, 820px); padding:19px 22px; border-radius:20px; border:1px solid rgba(148,163,184,.13); background:linear-gradient(145deg, rgba(13,22,38,.92), rgba(6,11,24,.88)); box-shadow:0 14px 30px rgba(0,0,0,.18), inset 0 1px 0 rgba(255,255,255,.05); }
        ...
        .clk-msg-role { display:flex; gap:9px; align-items:center; margin-bottom:9px; color:#67e8f9; font:750 11.5px var(--font-inter, sans-serif); letter-spacing:.02em; text-transform:none; }
        ...
        .clk-msg-text { margin:0; font-size:16.5px; line-height:1.72; color:#e1e9f5; white-space:pre-wrap; word-break:break-word; overflow-wrap:anywhere; }
        ...
        .clk-command { margin:18px 22px 0; }
        .clk-command-label { display:block; margin:0 0 6px; color:#5eead4; font:800 10.5px var(--font-plex-mono, monospace); letter-spacing:.14em; text-transform:uppercase; }
        .clk-command-line { margin:0; color:#8b99ae; font-size:13.5px; line-height:1.45; }
        .clk-input-wrap { margin:16px 22px 18px; border:1px solid rgba(34,211,238,.32); border-radius:16px; background:rgba(3,9,20,.9); transition:border-color .15s; }
        .clk-input-wrap:focus-within { border-color:rgba(34,211,238,.55); }
        .clk-input-row { display:grid; grid-template-columns:46px minmax(0, 1fr) auto 54px; gap:12px; align-items:center; min-height:78px; padding:10px 14px 10px 16px; }
        .clk-prompt-mark { height:42px; border-radius:11px; display:grid; place-items:center; color:#22d3ee; font:900 17px var(--font-plex-mono, monospace); background:rgba(34,211,238,.06); border:1px solid rgba(34,211,238,.16); }
        .clk-panel-input { width:100%; background:transparent; border:0; outline:0; color:#e5edf8; font-size:17px; caret-color:#22d3ee; }
        .clk-panel-input::placeholder { color:#7d899c; }
        .clk-helper { color:#7f8ea3; font-size:11.5px; white-space:nowrap; }
        .clk-send-btn { width:44px; height:44px; border-radius:11px; border:1px solid rgba(34,211,238,.45); color:#67e8f9; background:rgba(34,211,238,.08); display:grid; place-items:center; cursor:pointer; transition:border-color .15s, background .15s; }
        ...
        .clk-intel { margin-top:22px; }
        .clk-intel-head { margin:0 0 13px; }
        ...
        .clk-side-title { display:flex; align-items:center; gap:10px; margin:0 0 13px; padding-bottom:11px; border-bottom:1px solid rgba(148,163,184,.08); color:#dbe4f0; font-size:13px; font-weight:800; letter-spacing:.02em; text-transform:uppercase; }
        .clk-side-title svg { width:16px; height:16px; color:#22d3ee; }
        .clk-context-row { padding:0 0 10px; margin-bottom:10px; border-bottom:0; }
        .clk-context-row:last-child { margin-bottom:0; padding-bottom:0; }
        .clk-context-label { color:#7f8ea3; font:700 10px var(--font-plex-mono, monospace); letter-spacing:.08em; text-transform:uppercase; margin-bottom:5px; }
        .clk-context-value { color:#e5edf8; font-size:14.5px; font-weight:700; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
        .clk-context-sub { color:#6d7c94; font-size:11.5px; margin-top:3px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
