...
3. **Token Scanner beyond Base/ETH/BNB/Robinhood** — any plan to extend `toTokenApiChain()` to Polygon/Solana/Arbitrum, or is honest-unsupported permanent for those? See [[Supported-Chains-Limitations]].
